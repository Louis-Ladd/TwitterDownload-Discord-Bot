#Created By: Louis Harshman
#Created:‎Saturday, ‎August ‎14, ‎2021, ‏‎10:32:51 PM
#
#Purpose: To run a discord bot that waits for a command with a tweet URL. once we check if the tweet contains a video we use FFMPEG to download it, send it, then delete it.
